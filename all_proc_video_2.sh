...
cp /home/ptthang/data_mount/journal_data/Annotations/${seqname}/ -rf database/DAVIS/Annotations/Full-Resolution/
cp /home/ptthang/data_mount/journal_data/JPEGImages/${seqname}/ -rf database/DAVIS/JPEGImages/Full-Resolution/
...
# Optimization
bash scripts/template-accu.sh 2 $seqname 10007 "no" ""
